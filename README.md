...
| [Cline](https://docs.cline.bot/introduction/overview) | Coding agents | Yes | No | No | Yes | Yes | Yes | [Repo](https://github.com/cline/cline) |
...
| [Continue](https://docs.continue.dev/) | IDE assistants | Yes | No | No | Yes | Yes | No | [Repo](https://github.com/continuedev/continue) |
...
| [Chrome DevTools MCP](https://developer.chrome.com/blog/chrome-devtools-mcp) | MCP servers | Yes | Yes | No | No | No | Yes | [Repo](https://github.com/ChromeDevTools/chrome-devtools-mcp) |
...
| [Langfuse](https://langfuse.com/docs) | Agent observability | Yes | No | Yes | No | No | No | [Repo](https://github.com/langfuse/langfuse) |
...
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile/blob/main/README.md) | Local LLM developer tools | Yes | Yes | Yes | Yes | No | No | [Repo](https://github.com/Mozilla-Ocho/llamafile) |
...
| [Athenaeum](https://github.com/herakles-dev/athenaeum#readme) | Self-hosted AI dev stacks | Yes | Yes | Yes | No | No | Yes | [Repo](https://github.com/herakles-dev/athenaeum) |
| [Gemini CLI](https://developers.google.com/gemini-code-assist/docs/gemini-cli) | Coding agents | Yes | Yes | No | Yes | No | Yes | [Repo](https://github.com/google-gemini/gemini-cli) |
...
| [Harbor CLI Stack](https://github.com/harbor-ai/harbor#readme) | Self-hosted AI dev stacks | Yes | Yes | Yes | Yes | No | No | [Repo](https://github.com/harbor-ai/harbor) |
...
| [llama-cpp-python](https://llama-cpp-python.readthedocs.io) | Local LLM developer tools | Yes | Yes | Yes | Yes | No | No | [Repo](https://github.com/abetlen/llama-cpp-python) |
| [llama.cpp](https://github.com/ggml-org/llama.cpp/tree/master/examples) | Local LLM developer tools | Yes | Yes | Yes | Yes | No | No | [Repo](https://github.com/ggml-org/llama.cpp) |
| [MCP Bundles (MCPB)](https://modelcontextprotocol.io/docs/develop/build-with-agent-skills) | MCP servers | Yes | Yes | No | Yes | No | Yes | [Repo](https://github.com/modelcontextprotocol/mcpb) |
| [MCP Inspector](https://modelcontextprotocol.io/docs/tools/inspector) | MCP tooling | Yes | Yes | No | Yes | No | Yes | [Repo](https://github.com/modelcontextprotocol/inspector) |
...
| [Redis + Ollama RAG Stack](https://github.com/TtheBC01/redis-ollama-RAG#readme) | Self-hosted AI dev stacks | Yes | Yes | Yes | Yes | No | No | [Repo](https://github.com/TtheBC01/redis-ollama-RAG) |
| [Self-hosted AI Starter Kit (n8n)](https://docs.n8n.io/hosting/starter-kits/ai-starter-kit/) | Self-hosted AI dev stacks | Yes | Yes | Yes | Yes | No | No | [Repo](https://github.com/n8n-io/self-hosted-ai-starter-kit) |
...
| [Claude Code](https://code.claude.com/docs/en/setup) | Anthropic coding agent for terminal workflows that can read code, edit files, run commands, and use project context. | CLI · Hybrid |  |
| [Cline](https://docs.cline.bot/introduction/overview) | Open-source coding agent for editor workflows with file edits, terminal commands, browser use, and MCP-based tool extension. | Browser · CLI · IDE · Hybrid | [Repo](https://github.com/cline/cline) |
...
| [Gemini CLI](https://developers.google.com/gemini-code-assist/docs/gemini-cli) | Open-source terminal coding agent that uses tool calls and MCP servers to work on repository tasks. | CLI · MCP · Local | [Repo](https://github.com/google-gemini/gemini-cli) |
...
| [Cline](https://docs.cline.bot/introduction/overview) | Open-source coding agent for editor workflows with file edits, terminal commands, browser use, and MCP-based tool extension. | Browser · CLI · IDE · Hybrid | [Repo](https://github.com/cline/cline) |
| [CodeRabbit](https://coderabbit.ai/) | AI code review agent for pull requests, local IDE review, and terminal-based review workflows. | CLI · GitHub app · IDE · Hybrid | [Website](https://coderabbit.ai/) / [Docs](https://docs.coderabbit.ai/) |
| [Continue](https://docs.continue.dev/) | Open-source AI code assistant and CLI for IDE agents, source-controlled checks, and customizable development workflows. | CLI · IDE · Hybrid | [Repo](https://github.com/continuedev/continue) |
| [Cursor](https://cursor.com/) | AI code editor built around chat, codebase context, agents, rules, MCP, and terminal-assisted development workflows. | CLI · Desktop · IDE · Hybrid | [Website](https://cursor.com/) / [Docs](https://cursor.com/docs) |
| [Gemini Code Assist](https://developers.google.com/gemini-code-assist) | Google's coding assistant for IDEs and GitHub with agent mode, PR summaries, and code review. | GitHub app · IDE · Hosted | [Website](https://developers.google.com/gemini-code-assist) / [Docs](https://developers.google.com/gemini-code-assist/docs/overview) |
...
| [Anchor Browser](https://anchorbrowser.io) | Cloud-hosted browser fleet built for AI agents, providing human-like Chromium instances and deterministic browser task execution APIs. | API · Hosted |  |
| [Browser MCP](https://browsermcp.io) | Local MCP server and browser extension that connect AI apps to your real browser profile for automating web tasks using AI tools. | Browser · MCP · Local |  |
...
| [Browserbase](https://www.browserbase.com) | Cloud headless browser infrastructure built for AI agents and web automation, providing scalable browser sessions with anti-detection features. | API · Hosted | [Repo](https://github.com/browserbase/integrations) |
...
| [Charlotte MCP Server](https://vibehackers.io/mcp/charlotte) | Open-source MCP server that renders web pages into structured, token-efficient representations using headless Chromium for agents. | MCP · Self-hosted | [Repo](https://github.com/TickTockBent/charlotte) |
| [Cline](https://docs.cline.bot/introduction/overview) | Open-source coding agent for editor workflows with file edits, terminal commands, browser use, and MCP-based tool extension. | Browser · CLI · IDE · Hybrid | [Repo](https://github.com/cline/cline) |
| [Firecrawl](https://www.firecrawl.dev) | Open-source web data API for AI that lets agents search, scrape, and interact with the web at scale via HTTP, SDKs, CLI, and MCP. | API · CLI · Library · MCP · Hybrid | [Repo](https://github.com/firecrawl/firecrawl) |
...
| [Skyvern](https://pypi.org/project/skyvern/0.1.70/) | AI browser automation framework that uses LLMs and computer vision to automate multi-step workflows across websites via an API and SDK. | API · Library · Hybrid | [Repo](https://github.com/Skyvern-AI/skyvern) |
...
| [Chrome DevTools MCP](https://developer.chrome.com/blog/chrome-devtools-mcp) | MCP server that gives AI agents Chrome DevTools debugging capabilities for web applications. | MCP · Local | [Repo](https://github.com/ChromeDevTools/chrome-devtools-mcp) |
...
| [MCP Bundles (MCPB)](https://modelcontextprotocol.io/docs/develop/build-with-agent-skills) | CLI tool for packaging local MCP servers into installable .mcpb files. | CLI · Local | [Repo](https://github.com/modelcontextprotocol/mcpb) |
...
| [Playwright MCP Server](https://playwright.dev/docs/getting-started-mcp) | MCP server that uses Playwright to let AI agents interact with web pages through accessibility snapshots. | MCP · Local | [Repo](https://github.com/microsoft/playwright-mcp) |
...
| [MCP C# SDK](https://csharp.sdk.modelcontextprotocol.io) | Official C# SDK for MCP servers and clients, maintained with Microsoft and published to NuGet. | Library | [Repo](https://github.com/modelcontextprotocol/csharp-sdk) |
...
| [MCP Framework (QuantGeekDev)](https://mcp-framework.com/) | TypeScript-first framework and CLI for building MCP servers with automatic discovery and multi-transport support. | CLI · Framework | [Repo](https://github.com/QuantGeekDev/mcp-framework) |
| [MCP Inspector](https://modelcontextprotocol.io/docs/tools/inspector) | Official visual and command-line testing tool for developing, inspecting, and debugging Model Context Protocol servers. | CLI · MCP · Web · Local | [Repo](https://github.com/modelcontextprotocol/inspector) |
...
| [MCP Rust SDK (rmcp)](https://crates.io/crates/rmcp) | Rust SDK for implementing MCP clients and servers, published as the rmcp crate. | Library | [Repo](https://github.com/modelcontextprotocol/rust-sdk) |
...
| [mcpscan.ai](https://mcpscan.ai) | Web-based security scanner for discovering vulnerabilities in MCP server implementations and configurations. | Web |  |
...
| [Langfuse](https://langfuse.com/docs) | Open-source LLM engineering platform for observability, tracing, prompt management, datasets, and evaluations. | API · Web · Hybrid | [Repo](https://github.com/langfuse/langfuse) |
...
| [OpenInference](https://arize-ai.github.io/openinference/) | Open-source OpenTelemetry-based specification and instrumentations for tracing AI and LLM applications. | Library · Local | [Repo](https://github.com/Arize-ai/openinference) |
...
| [AWS Agent Evaluation](https://awslabs.github.io/agent-evaluation/) | Generative AI-powered framework from AWS Labs to test virtual agents via multi-turn conversations and CI-friendly workflows. | CLI · Framework · Library | [Repo](https://github.com/awslabs/agent-evaluation) |
...
| [LangFair](https://cvs-health.github.io/langfair/) | Python library for use-case level LLM bias and fairness assessment using bring-your-own-prompts workflows. | Framework · Library | [Repo](https://github.com/cvs-health/langfair) |
| [Langfuse](https://langfuse.com/docs) | Open-source LLM engineering platform for observability, tracing, prompt management, datasets, and evaluations. | API · Web · Hybrid | [Repo](https://github.com/langfuse/langfuse) |
...
| [Athenaeum](https://github.com/herakles-dev/athenaeum#readme) | Self-hosted semantic library platform with embeddings, chat UI, pgvector, and MCP server support. | API · MCP · Web · Self-hosted | [Repo](https://github.com/herakles-dev/athenaeum) |
| [Clawix AI Platform](https://github.com/ClawixAI/clawix#readme) | Open-source, self-hosted multi-agent AI orchestration platform running agents in isolated Docker containers. | CLI · Web · Self-hosted | [Repo](https://github.com/ClawixAI/clawix) |
| [DevBox AI Dev Stack](https://github.com/gl0bal01/devbox#readme) | Zero-trust dev environment repository including an AI dev stack installer for Docker-based tools on a VPS. | CLI · Self-hosted | [Repo](https://github.com/gl0bal01/devbox) |
...
| [Harbor CLI Stack](https://github.com/harbor-ai/harbor#readme) | CLI tool that spins up a local LLM stack (Ollama, Open WebUI, others) with a single command using container orchestration. | CLI · Template · Local | [Repo](https://github.com/harbor-ai/harbor) |
...
| [Langfuse](https://langfuse.com/docs) | Open-source LLM engineering platform for observability, tracing, prompt management, datasets, and evaluations. | API · Web · Hybrid | [Repo](https://github.com/langfuse/langfuse) |
| [Local LLM Docker (mythrantic)](https://github.com/mythrantic/ollama-docker#readme) | Docker Compose setup for running Ollama and a web UI in containers with GPU optional. | Web · Self-hosted | [Repo](https://github.com/mythrantic/ollama-docker) |
...
| [Paddler](https://github.com/intentee/paddler#readme) | Open-source LLMOps platform for hosting and scaling AI models in your own infrastructure. | API · CLI · Web · Self-hosted | [Repo](https://github.com/intentee/paddler) |
...
| [Redis + Ollama RAG Stack](https://github.com/TtheBC01/redis-ollama-RAG#readme) | Docker-based stack using RedisVL, Ollama, FastAPI, and RQ worker to build a local RAG pipeline. | API · CLI · Self-hosted | [Repo](https://github.com/TtheBC01/redis-ollama-RAG) |
| [Refact.ai](https://refact.ai/) | Coding agent for IDEs and enterprises that can automate coding, debugging, testing, and documentation tasks. | IDE · Web · Hybrid | [Website](https://refact.ai/) / [Docs](https://docs.refact.ai/) / [Repo](https://github.com/smallcloudai/refact-vscode) |
| [Scalable Agentic RAG Platform (FareedKhan-dev)](https://github.com/FareedKhan-dev/scalable-rag-pipeline#readme) | Production-grade agentic RAG platform with Kubernetes, Ray, LangGraph, and multi-plane architecture. | CLI · Self-hosted | [Repo](https://github.com/FareedKhan-dev/scalable-rag-pipeline) |
...
| [Self-hosted AI Starter Kit (n8n)](https://docs.n8n.io/hosting/starter-kits/ai-starter-kit/) | Docker Compose-based local AI and low-code stack bundling n8n, Ollama, Qdrant, PostgreSQL, and related services. | API · CLI · Web · Self-hosted | [Repo](https://github.com/n8n-io/self-hosted-ai-starter-kit) |
...
| Tool | Good for | Experience | Links |
| --- | --- | --- | --- |
| [AutoGPTQ](https://github.com/AutoGPTQ/AutoGPTQ#readme) | Python library for GPTQ weight-only quantization of Transformer language models for efficient local inference. | Library · Local | [Repo](https://github.com/AutoGPTQ/AutoGPTQ) |
...
| [ExLlamaV2](https://github.com/turboderp-org/exllamav2#readme) | Inference library for running GPTQ-quantized LLMs on modern consumer GPUs with high performance. | CLI · Library · Local | [Repo](https://github.com/turboderp-org/exllamav2) |
...
| [llama-cpp-python](https://llama-cpp-python.readthedocs.io) | Python bindings and OpenAI-compatible web server for llama.cpp, exposing local models via HTTP and Python APIs. | API · CLI · Library · Self-hosted | [Repo](https://github.com/abetlen/llama-cpp-python) |
| [llama.cpp](https://github.com/ggml-org/llama.cpp/tree/master/examples) | C/C++ LLM inference library and tools for running quantized models on CPUs and GPUs with optional HTTP and OpenAI-style servers. | API · CLI · Library · Self-hosted | [Repo](https://github.com/ggml-org/llama.cpp) |
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile/blob/main/README.md) | Single-file local LLM runtime bundling llama.cpp and web UI, with an OpenAI-compatible /v1 chat completions endpoint. | API · CLI · Web · Local | [Repo](https://github.com/Mozilla-Ocho/llamafile) |
...
| [LLM Compressor](https://docs.vllm.ai/projects/llm-compressor/en/latest/) | Compression and quantization library for optimizing LLMs for deployment with vLLM. | Library · Local | [Repo](https://github.com/vllm-project/llm-compressor) |
| [llm-llamafile](https://github.com/simonw/llm-llamafile#readme) | Plugin for the `llm` CLI that lets you use a locally running llamafile server as an LLM provider. | CLI · Library · Local | [Repo](https://github.com/simonw/llm-llamafile) |
...
| [Mistral Inference](https://github.com/mistralai/mistral-inference#readme) | Official inference library for running Mistral models via CLI and Python on local or server hardware. | CLI · Library · Self-hosted | [Repo](https://github.com/mistralai/mistral-inference) |
| [mistral.rs](https://github.com/EricLBuehler/mistral.rs/blob/master/docs/README.md) | Rust-based engine for fast, flexible LLM inference with OpenAI-compatible APIs, web UI, and extensive quantization options. | API · CLI · Library · Web · Self-hosted | [Repo](https://github.com/EricLBuehler/mistral.rs) |
...
| [MLX Engine for LM Studio](https://github.com/lmstudio-ai/mlx-engine#readme) | Apple MLX-based inference engine used by LM Studio to run quantized text and vision models locally on macOS. | Library · Local | [Repo](https://github.com/lmstudio-ai/mlx-engine) |
| [mlx-lm](https://github.com/ml-explore/mlx-lm#readme) | Apple MLX-based Python package for running and fine-tuning LLMs on Apple silicon, with an HTTP server similar to OpenAI chat API. | API · CLI · Library · Local | [Repo](https://github.com/ml-explore/mlx-lm) |
...
| [Tabby](https://www.tabbyml.com/) | Self-hosted AI coding assistant for teams that want private code assistance and repository-aware development. | API · IDE · Self-hosted | [Website](https://www.tabbyml.com/) / [Docs](https://tabby.tabbyml.com/docs/) / [Repo](https://github.com/TabbyML/tabby) |
| [TabbyAPI](https://github.com/theroyallab/tabbyAPI#readme) | FastAPI-based backend server for ExLlamaV2 that exposes local text generation over HTTP for coding and chat workloads. | API · Self-hosted | [Repo](https://github.com/theroyallab/tabbyAPI) |
...
| [text-generation-webui](https://github.com/oobabooga/text-generation-webui#readme) | Self-hosted Gradio/Web UI and API for running diverse local text generation models on CPUs and GPUs. | CLI · Web · Self-hosted | [Repo](https://github.com/oobabooga/text-generation-webui) |
...
| [automerge-action](https://github.com/marketplace/actions/merge-pull-requests-automerge-action) | GitHub Action that automatically merges pull requests labeled for automerge once checks and reviews pass. | GitHub app | [Repo](https://github.com/pascalgn/automerge-action) |
...
| [Factory Droid](https://factory.ai/) | Coding agent platform with CLI, desktop, and headless automation for code changes, review, and CI workflows. | API · CLI · Desktop · Hybrid | [Website](https://factory.ai/) / [Docs](https://docs.factory.ai/welcome) |
| [Gemini Code Assist](https://developers.google.com/gemini-code-assist) | Google's coding assistant for IDEs and GitHub with agent mode, PR summaries, and code review. | GitHub app · IDE · Hosted | [Website](https://developers.google.com/gemini-code-assist) / [Docs](https://developers.google.com/gemini-code-assist/docs/overview) |
| [GitHub Dependabot](https://docs.github.com/en/copilot/tutorials/copilot-chat-cookbook/analyze-security/manage-dependency-updates) | GitHub-native service that configures and runs automated security and version dependency update pull requests. | GitHub app · Hosted |  |
| [GitHub Stacked PRs (gh stack)](https://github.github.com/gh-stack/) | Native GitHub feature and gh CLI support for creating and managing stacked pull requests for large changes. | CLI · Local |  |
...
| [OpenCode](https://opencode.ai/) | Open-source AI coding agent for terminal, desktop, IDE, and GitHub repository workflows. | CLI · Desktop · GitHub app · IDE · MCP · Local | [Website](https://opencode.ai/) / [Docs](https://opencode.ai/docs/) / [Repo](https://github.com/anomalyco/opencode) |
| [Pull Request Labeler (actions/labeler)](https://github.com/marketplace/actions/labeler) | GitHub Action that automatically labels pull requests based on changed file paths or branch names. | GitHub app | [Repo](https://github.com/actions/labeler) |
| [Release Please](https://github.com/googleapis/release-please-action) | Tool and GitHub Action that automates changelog updates, GitHub releases, and version bumps using Conventional Commits. | CLI · GitHub app | [Repo](https://github.com/googleapis/release-please) |
...
| [Renovate](https://docs.renovatebot.com) | Automated dependency update bot that scans repositories and opens pull requests to keep dependencies up to date. | CLI · GitHub app · Hybrid | [Repo](https://github.com/renovatebot/renovate) |
| [Roo Code](https://roocode.com/) | Open-source coding agent for VS Code and cloud agents that can code, review, and automate repository tasks. | CLI · IDE · Web · Hybrid | [Website](https://roocode.com/) / [Docs](https://docs.roocode.com/) / [Repo](https://github.com/RooCodeInc/Roo-Code) |
| [semantic-release](https://semantic-release.gitbook.io/semantic-release/recipes/ci-configurations/github-actions) | CLI tool that automates semantic versioning, changelog generation, tagging, and publishing from commit history. | CLI · Local | [Repo](https://github.com/semantic-release/semantic-release) |
| [Shelfi AI GitHub Bot](https://shelfi.sh/features/github-ai-bot/) | AI-powered GitHub bot that analyzes pull requests and suggests documentation updates tied to code changes. | GitHub app · Web · Hosted |  |
...
| [stale-repos Action](https://github.com/marketplace/actions/stale-repos) | GitHub Action that identifies inactive repositories in an organization and reports them for archival decisions. | GitHub app | [Repo](https://github.com/github/stale-repos) |
...
| [AutoCodeDocs](https://autocodedocs.ai) | Hosted tool that analyzes code and generates structured Markdown documentation, READMEs, and API references. | Web · Hosted |  |
| [AWS Documentation MCP Server](https://github.com/awslabs/mcp/tree/main/src/aws-documentation-mcp-server) | MCP server that exposes AWS documentation search and retrieval tools to AI assistants. | MCP · Hosted | [Repo](https://github.com/awslabs/mcp) |
| [Code2Docs](https://github.com/code2docs-ai) | AI system and CLI that converts GitHub repositories into structured markdown documentation and exports docs. | CLI · Web | [Repo](https://github.com/xKarinSan/Code2Docs) |
...
| [Documentation.AI](https://documentation.ai) | AI documentation platform for product docs, API references, and internal knowledge with assistant and automation. | Web · Hosted |  |
...
| [DocWhizz](https://www.docwhizz.com) | AI assistant embedded in developer docs that answers API questions and highlights documentation gaps. | Web · Hosted |  |
...
| [GitCrafts](https://gitcrafts.pro) | Hosted assistant that generates professional documentation for GitHub repositories using AI. | Web · Hosted |  |
...
| [Stenography](https://stenography.dev) | AI-powered codebase documenter with API and editor extensions for automatic code explanations and docs. | API · IDE · Hosted |  |
...
| --- | --- | --- | --- |
| [Action to update GitHub Action documentation](https://github.com/marketplace/actions/action-to-update-github-action-documentation) | Repo automation tools | Draft: source_model=not specified. |  |
| [action-github-changelog-generator](https://github.com/marketplace/actions/generate-changelog) | Repo automation tools | Draft: source_model=not specified. |  |
...
| [Auto Documentation & Docstrings Action](https://github.com/marketplace/actions/auto-documentation-docstrings) | Documentation agents | Draft: source_model=not specified. |  |
| [auto-generate-changelog](https://github.com/marketplace/actions/auto-generate-changelog) | Repo automation tools | Draft: source_model=not specified. |  |
| [Auto-Merge Pull Request](https://github.com/marketplace/actions/auto-merge-pull-request) | Repo automation tools | Draft: source_model=not specified. |  |
| [Automatic Pull Request (AutoPR)](https://github.com/marketplace/actions/automatic-pull-request) | Repo automation tools | Draft: source_model=not specified. |  |
| [Automatic Pull Request Review](https://github.com/marketplace/actions/automatic-pull-request-review) | Repo automation tools | Draft: source_model=not specified. |  |
...
| [Dependencies Autoupdate Action](https://github.com/marketplace/actions/dependencies-autoupdate) | Repo automation tools | Draft: source_model=not specified. |  |
...
| [DrMLlm](https://github.com/Vybhav448/DrMLlm#readme) | Self-hosted AI dev stacks | Draft: source_model=not specified. | [Repo](https://github.com/Vybhav448/DrMLlm) |
| [Generate AI Documentation Action](https://github.com/marketplace/actions/generate-ai-documentation) | Documentation agents | Draft: source_model=not specified. |  |
...
| [GitHub Maintenance Action](https://github.com/marketplace/actions/github-maintenance-action) | Repo automation tools | Draft: source_model=not specified. |  |
